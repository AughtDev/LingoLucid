...
export default function NumberedIcon({num, icon: Icon, ...props}: NumberedIconProps) {
    const size = props.size || 24
    return <IconHoverEffects icon={(props) => (
        <div className={"relative flex flex-col items-center justify-center"}>
            {num > 0 ? <div className={"absolute top-0 left-0 -translate-x-1/3 -translate-y-1/3"}>
                <div
